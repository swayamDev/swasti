        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              ...
              className="from-primary via via-primary/50 to-primary/30 bg-linear-to-r bg-clip-text text-2xl font-bold text-transparent transition-opacity hover:opacity-80"
              aria-label="home"
            >
          ...
          <div className="hidden items-center gap-2 md:flex">
            <button
              ...
              className="rounded-[17px] rounded-lg border border-white bg-white px-7 py-3.5 text-base font-medium text-[#212121] transition-all duration-300 hover:bg-white/90"
            >
              Hire Me
            </button>
          </div>
